...
import * as userClickCar from '../../../../actions/cars/userClickCar';
...
@connect(
    state => {
        return { ...state.userClickCar };
    },
    dispatch => bindActionCreators({ ...userClickCar }, dispatch)
)
export default class userClickCarList extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
